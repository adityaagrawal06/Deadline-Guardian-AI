  ...
  return (
    <div className="flex min-h-screen bg-[#050505] text-text font-sans overflow-hidden">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-center px-20 z-10 border-r border-white/5 bg-gradient-to-br from-[#0a0a0a] to-[#0f0f13]">
        ...
        >
          ...
          <h1 className="text-6xl font-extrabold leading-[1.1] mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-white/90 to-white/50">
            Join the<br/>AI Productivity<br/>
            <span className="text-primary drop-shadow-[0_0_15px_rgba(var(--primary),0.3)]">Revolution.</span>
          </h1>
          <p className="text-lg text-text-muted max-w-md leading-relaxed font-medium">
            Create your professional profile and let autonomous AI orchestrate your success.
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12 relative z-20">
        ...
        >
          {/* Glassmorphic Card */}
          <div className="rounded-[32px] bg-white/[0.02] border border-white/[0.05] p-8 sm:p-10 backdrop-blur-3xl shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            ...
            >
              ...
              <p className="text-sm text-text-muted font-medium">Set up your professional workspace.</p>
            </motion.div>
            ...
            >
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <select 
                    ...
                    className="w-full bg-black/20 border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-primary transition-colors appearance-none [&>option]:bg-surface [&>option]:text-white"
                  >
                ...
                <div className="flex-1">
                  <label className="block text-xs font-bold text-text-muted uppercase tracking-wider mb-2">Organization</label>
                  <input 
              ...
              <button 
                type="submit"
                className="w-full mt-4 bg-primary hover:bg-primary/90 text-white font-bold py-3.5 rounded-xl transition-all hover:shadow-[0_0_20px_rgba(124,58,237,0.4)]"
              >
                Create Account
              </button>
              ...
              <div className="w-full flex items-center gap-4 my-2">
                ...
                <span className="text-xs text-text-muted uppercase tracking-widest font-bold">Or Setup With</span>
                <div className="h-px bg-white/10 flex-1"></div>
              </div>
          ...
          >
            Already have an account? <Link to="/" className="text-primary hover:text-white transition-colors font-bold">Sign In</Link>
          </motion.p>
        </motion.div>
      </div>
    </div>
